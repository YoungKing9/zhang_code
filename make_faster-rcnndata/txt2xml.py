...
def makexml(picPath, xmlPath):  # txt所在文件夹路径，xml文件保存路径，图片所在文件夹路径
    ...
    #
    #        }
    dic = {0: 'shoes', 1: 'bin', 2: 'pedestal', 3: 'wire', 4: 'socket', 5: 'cat', 6: 'dog', 7: 'desk_rect', 8: 'desk_circle', 9: 'weighing-scale'}
    ...
    for i, name in enumerate(files):
        ...
        f = open(save_paths + name.split('/')[-1][:-4] + ".xml", 'w')
...
if __name__ == "__main__":
    ...
    xmlPath = "/data/VOC/voc2017/Annotations/"  # xml文件保存路径，后面的/一定要带上
